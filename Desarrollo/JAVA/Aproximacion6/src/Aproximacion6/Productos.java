...
public class Productos {
    ...
    private Aproximacion6.Encargado[] encargadoList;
    ...
    public Productos(String id, String nombreproducto) {
        ...
        encargadoList = new Aproximacion6.Encargado[50];
        semanas = 0;
    }
    ...
    public void adicionarVentas(int id, String nombre) {
        Aproximacion6.Encargado encargado = new Aproximacion6.Encargado();
