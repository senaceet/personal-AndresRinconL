...
public class Productos {
    ...
    private Aproximacion5.Encargado[] encargadoList;
    ...
    public Productos(String id, String nombreproducto) {
        ...
        encargadoList = new Aproximacion5.Encargado[50];
        semanas = 0;
    }
    ...
    public void adicionarVentas(int id, String nombre) {
        Aproximacion5.Encargado encargado = new Aproximacion5.Encargado();
